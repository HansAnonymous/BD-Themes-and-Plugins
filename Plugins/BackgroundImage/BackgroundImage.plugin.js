...
class BackgroundImage {
	...
	start() {
		BdApi.injectCSS("BackgroundImage",`
			...
			.app.flex-vertical.theme-dark, .layers.flex-vertical.flex-spacer, .layers-20RVFW, .layer-kosS71, .container-2OU7Cz, .titleWrapper-3Vi_wz, .theme-dark .title-qAcLxz {
